...
void main() {
  setUpAll(() async {
    ...
    WidgetsBinding.instance.platformDispatcher.views.first.physicalSize = const Size(2048, 1024);
    WidgetsBinding.instance.platformDispatcher.views.first.devicePixelRatio = 1.0;
